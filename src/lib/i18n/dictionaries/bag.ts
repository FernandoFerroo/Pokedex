...
const es = {
  ...
  itemDesc: {
    potion: "Restaura 20 PS.",
    "super-potion": "Restaura 60 PS.",
    "hyper-potion": "Restaura 120 PS.",
...
const fr: typeof es = {
  ...
  itemDesc: {
    potion: "Rend 20 PV.",
    "super-potion": "Rend 60 PV.",
    "hyper-potion": "Rend 120 PV.",
...
const de: typeof es = {
  ...
  itemDesc: {
    potion: "Stellt 20 KP wieder her.",
    "super-potion": "Stellt 60 KP wieder her.",
    "hyper-potion": "Stellt 120 KP wieder her.",
...
const it: typeof es = {
  ...
  itemDesc: {
    potion: "Ripristina 20 PS.",
    "super-potion": "Ripristina 60 PS.",
    "hyper-potion": "Ripristina 120 PS.",
...
const ja: typeof es = {
  ...
  itemDesc: {
    potion: "HPを20かいふくする。",
    "super-potion": "HPを60かいふくする。",
    "hyper-potion": "HPを120かいふくする。",
...
const ko: typeof es = {
  ...
  itemDesc: {
    potion: "HP를 20 회복한다.",
    "super-potion": "HP를 60 회복한다.",
    "hyper-potion": "HP를 120 회복한다.",
...
const zhHans: typeof es = {
  ...
  itemDesc: {
    potion: "回复20点HP。",
    "super-potion": "回复60点HP。",
    "hyper-potion": "回复120点HP。",
...
const zhHant: typeof es = {
  ...
  itemDesc: {
    potion: "回復20點HP。",
    "super-potion": "回復60點HP。",
    "hyper-potion": "回復120點HP。",
